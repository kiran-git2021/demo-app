...
export const description = "An interactive line chart with zoom functionality"
    ...
    <Card className="py-4 sm:py-0">
      <CardHeader className="flex flex-col items-stretch border-b !p-0 sm:flex-row">
        <div className="flex flex-1 flex-col justify-center gap-1 px-6 pb-3 sm:pb-0">
          <CardTitle>Line Chart - Interactive with Zoom</CardTitle>
          <CardDescription>
            Showing data history for the last 3 months. Click and drag to zoom, or use controls.
          </CardDescription>
        </div>
        <div className="flex">
        ...
        <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
          ...
          >
            ...
            />
              ...
              dataKey={activeChart}
              type="monotone"
              stroke={chartConfig[activeChart].color} // ✅ fixed
